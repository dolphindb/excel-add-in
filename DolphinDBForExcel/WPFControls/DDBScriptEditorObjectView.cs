...
namespace DolphinDBForExcel.WPFControls
{
    public partial class DDBScriptEditor : UserControl
    {
        ...
        class ObjectViewTreeHelper
        {
            ...
            public static BitmapSource docBitSource = BitmapToBitmapSource.Conv(AddinResource.document);
            public static BitmapSource folderBitSource = BitmapToBitmapSource.Conv(AddinResource.folder);
            public static BitmapSource openedFolderBitSource = BitmapToBitmapSource.Conv(AddinResource.opened_folder);
