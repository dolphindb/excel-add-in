...
namespace DolphinDBForExcelCore
{
    ...
    {
        public Win32Window(int winHwnd)
        {
    ...
    {
        public static void Conv(Bitmap bitmap, out BitmapSource bsource)
        {
            bsource = System.Windows.Interop.Imaging.CreateBitmapSourceFromHBitmap(
